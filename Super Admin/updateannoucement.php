...
<html>
    ...
    <form  class="form-container"  method="POST" action="updateproductinfo.php" enctype="multipart/form-data">
            ...
            <input name="name" type="text" class="form-login"  placeholder="<?php  echo $name; ?>" required><br />
            <label><b>Product Details </b></label><br/>
            <textarea name="details" class="form-message" placeholder="<?php  echo $details; ?>"  row="10" required></textarea><br />
