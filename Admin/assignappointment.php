  ...
  <div class="login-title">
    ...
    <form class="modal-content"  method="POST" action="updateappointment.php" enctype="multipart/form-data">
        <div class="container">
            ...
            <label style="text-align: left;"><b>Customer Name</b></label><br/>
            ...
            <input name="subject" type="text" class="form-login" style="text-color: black;" placeholder="<?php echo $subject; ?>"><br />
            ...
            <p style="text-align: right; font-size: 18px; font-family: cursive; color:black; padding-right: 380px">Back to <a href="sprofile.php" style="color: black">HOME</a></p>
        </div>
        </form>
            </div>
        </div>
