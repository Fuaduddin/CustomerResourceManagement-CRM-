...
$row = mysqli_fetch_assoc($query);
    ...
    <div class="fooditems" style="text-align: center; padding-left: 250px;">
	                ...
	                while ($row = mysqli_fetch_array($result)) {
	                    ...
	                    <div style="float:left;">
                            ...
                            <div class="item"style="padding-left: 20px">
                            	<div class="foodpic">
	                                <img src="<?php echo 'imgs/' . $row['image'] ?>" width="150" height="250" alt='Profile pic' class="img-responsive"><br /><br />
	                            </div>
       ...
       <div style="width: 75%: padding-left: 55px; align-content: center;">
          <h1 style="text-align: center; padding-top: 20px;"> Appoinment </h1>
     <div class="container">
 <table id="example" class="display" style="width:45%; padding-left: 55px; align-content: center;">
              ...
              $row = mysqli_fetch_assoc($query);
              $email= $row["email"];
             $sql = "SELECT * FROM `productdetails` where category='$type ' ORDER BY name ASC"; 
                              ...
                              while($row = mysqli_fetch_assoc($result))
                                {
                                        echo "<td>";
                                  ?>
                                           <img src="<?php echo 'imgs/' . $row['image'] ?>" width="150" height="250" alt='Profile pic' class="img-responsive">
                                        <?php
                                        echo "</td>";
                                    echo "<td>";
                                            echo $row["name"];
