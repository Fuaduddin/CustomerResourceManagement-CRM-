...
$row = mysqli_fetch_assoc($query);
    ...
    <div class='card mb-3 container' style='margin-top: 30px; padding-left: 15px;'>
          <h1 style="text-align: center;">New Appoinments </h1>
 ...
 <table  class="table table-bordered" style="width: 80%;">
              ...
              $row = mysqli_fetch_assoc($query);
              $email= $row["email"];
             $sql1 = "select * from `appointment` where s_email='$email' and done='0' order by date ASC";
       ...
       <div class='card mb-3 container' style='margin-top: 30px; padding-left: 15px;'>
          <h1 style="text-align: center;">Cancel Appoinments </h1>
         <div style="padding-left:200px;">
     <div class="container">
 <table  class="table table-bordered" style="width: 80%;">
                                    <thead class="thead-dark">
              ...
              $row = mysqli_fetch_assoc($query);
              $email= $row["email"];
             $sql1 = "select * from `appointment` where s_email='$email' and done='2' order by date ";
            $result = mysqli_query($con, $sql1);
                if(mysqli_num_rows($result)>0)
                {
                              while($row = mysqli_fetch_assoc($result))
