...
$row = mysqli_fetch_assoc($query);
        ...
        <img src="<?php echo 'imgs/' . $row['image'] ?>" alt='Profile pic'><br /><br />
            ...
            ?>
         <a href="customereditprofile.php"<?php  $_SESSION['staffid']=$row["s_id"]; ?> style="text-align: right; font-family: cursive" class="btn btn-secondary">Edit Profile</a>
            </div>
...
<div class="container" style=" align-content: center; padding-top:40px;">
   ...
   <div id="result" style="padding-left: 140px; align-content: center;">
    ...
    $cid=$_SESSION["customerid"];
     $con = mysqli_connect("localhost","root","","crm");
    $sql2 = "SELECT * FROM `customer` where c_id='$cid' limit 1";//ORDER BY id desc
